...
\textbf{Вход:} $x_k$, $\alpha_0 > 0$, $c_1 \in (0,1)$, $\beta \in (0,1)$\\
\textbf{Шаг 1:} Вычислить $g \leftarrow \grad f(x_k)$, установить $\alpha \leftarrow \alpha_0$\\
\textbf{Шаг 2:} \textbf{Пока} $f(x_k - \alpha g) > f(x_k) - c_1\,\alpha\,\norm{g}^2$:\\
\quad $\alpha \leftarrow \beta \cdot \alpha$\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{results/plots/fig_iter_vs_step_Quad.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{results/plots/fig_traj_linesearch_Quad.png}
