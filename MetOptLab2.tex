...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{results/plots/fig_surface_well.png}
        \caption{Поверхность $f(x,y)=x^2+y^2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{results/plots/fig_surface_ill.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{results/plots/fig_surface_Ros.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{results/plots/fig_surface_Ack.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{results/plots/fig_surface_Him.png}
